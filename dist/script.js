...
/* harmony import */ var _modals__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modals */ "./src/js/modules/modals.js");
...
function closeModal(modalSelector) {
  ...
  modalWindow.classList.remove('show'); // document.body.style.overflow = '';
}
...
var modals = function modals() {
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // showModalByTime('.popup_engineer', 60000);
};
